...
class RawframeDataset(BaseActionDataset):
    ...
    The dataset loads raw frames and applies specified transforms to return a
    ...
    def __init__(self,
                 ...
                 ann_file: str = 'path/to/your/annotation/file.txt',  # Default annotation file path
                 data_prefix: ConfigType = dict(img='path/to/your/data/'),  # Default data prefix
