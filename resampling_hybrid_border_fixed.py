...
def resample_pickle_data(input_file, train_output_file, val_output_file):
    ...
    def resample_annotations(annotations):
        ...
        # Apply BorderlineSMOTE and EditedNearestNeighbours to keypoints
...
resample_pickle_data(
    ...
    train_output_file=r"/root/pyskl_thesis/test/hybrid_resample_aug_8_train.pkl",
    val_output_file=r"/root/pyskl_thesis/test/hybrid_resample_aug_8_val.pkl"
)
