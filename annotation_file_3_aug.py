...
# Example usage
video_label_txt = r"D:\pyskl-main\pyskl-main\frame\video_label.txt"  # Input text file containing video paths and labels
...
output_pickle = 'hand_pose_dataset_with_aug_0.pkl'  # Output pickle file
