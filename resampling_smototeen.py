...
def resample_pickle_data(input_file, train_output_file, val_output_file):
    ...
    def resample_annotations(annotations, synthetic=False):
        ...
        # Apply SMOTEENN globally across all classes
        smote_enn = SMOTEENN(random_state=42)
        try:
            resampled_features, resampled_labels = smote_enn.fit_resample(features, labels)
        except ValueError as e:
            print(f"Error during SMOTEENN resampling: {e}")
...
resample_pickle_data(
    ...
    train_output_file=r"/root/pyskl_thesis/smoteenn_aug_8_train.pkl",
    val_output_file=r"/root/pyskl_thesis/smoteenn_aug_8_val.pkl"
)
